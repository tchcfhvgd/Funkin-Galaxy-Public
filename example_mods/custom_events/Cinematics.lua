...
function onUpdate()	if StartStop == 1 then
	...
	doTweenY('Cinematics1', 'UpperBar', -75, Speed, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 675, Speed, 'Linear')
	setObjectCamera('UpperBar', 'hud')
	setObjectCamera('LowerBar', 'hud')
	setObjectOrder('UpperBar', '6')
	setObjectOrder('LowerBar', '6')
	...
	setObjectCamera('UpperBar', 'hud')
	setObjectCamera('LowerBar', 'hud')
	setObjectOrder('UpperBar', '1')
	setObjectOrder('LowerBar', '1')
	doTweenAlpha('AlphaTween1', 'healthBarBG', 0, 0.1)
	doTweenAlpha('AlphaTween2', 'healthBar', 0, 0.1)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 0, 0.1)
	doTweenAlpha('AlphaTween4', 'iconP1', 0, 0.1)
