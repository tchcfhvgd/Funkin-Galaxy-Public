...
leftMissoffsets = {'-3', '3'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'1', '-2'}  --
upMissoffsets = {'4', '-7'}    --
rightMissoffsets = {'3', '1'} --
...
idle_xml_name = 'buigi idle'
left_xml_name = 'buigi left'
down_xml_name = 'buigi down'
up_xml_name = 'buigi up'
right_xml_name = 'buigi right'

left_miss_xml_name = 'buigi missleft'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'buigi missdown'   --
up_miss_xml_name = 'buigi missup'       --
right_miss_xml_name = 'buigi missright' --
...
name_of_character_xml = 'Luigi/buigi'
name_of_character = 'sexy-luigi'
name_of_notetype = 'Luigi'
name_of_notetype2 = 'LuigiBF' -- for multiple characters singing at the same time
